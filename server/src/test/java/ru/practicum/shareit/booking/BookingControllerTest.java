...
class BookingControllerTest {
    ...
    void getUserBookingsByState_whenInvokedWithCorrectParams_thenReturnedUserBookings() {
        ...
        when(bookingService.getBookingByUserIdAndState(GetBookingsParam.of(userId, BookingState.ALL, 0, 10)))
                .thenReturn(bookings);
        ...
        verify(bookingService, times(1))
                .getBookingByUserIdAndState(GetBookingsParam.of(userId, BookingState.ALL, 0, 10));
