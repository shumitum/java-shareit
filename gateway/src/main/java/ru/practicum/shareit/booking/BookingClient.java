...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getBookingByUserIdAndState(long userId, BookingState state, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> getOwnerItemsByState(long ownerId, BookingState state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
